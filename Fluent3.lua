			...
			if not RunService:IsStudio() and Mobile and Minimizer then
				pcall(function()
					...
					if minimizeButton then
						...
						if imageLabel then
							imageLabel.Image = Window.Minimized and "rbxassetid://10734896384" or "rbxassetid://112737801234686"
						end
					end
				end)
			end
...
local Icons = {
	...
	["lucide-moon"] = "rbxassetid://112737801234686",
...
local MinimizeButton = New("TextButton", {
	...
	New("ImageLabel", {
		Image = Mobile and (Button_Icon ~= "" and Button_Icon or "rbxassetid://112737801234686") or "rbxassetid://112737801234686",
		Size = UDim2.new(1, 0, 1, 0),
		BackgroundTransparency = 1,
	}, {
