if (game:GetService("CoreGui")):FindFirstChild("Nox Hub") and (game:GetService("CoreGui")):FindFirstChild("ScreenGui") then
...
ImageButton.MouseButton1Click:connect(function()
	(game.CoreGui:FindFirstChild("Nox Hub")).Enabled = not (game.CoreGui:FindFirstChild("Nox Hub")).Enabled;
end);
...
(getgenv()).LoadConfig = function()
	if readfile and writefile and isfile and isfolder then
		if not isfolder("Nox Hub") then
			makefolder("Nox Hub");
		end;
		if not isfolder("Nox Hub/Library/") then
			makefolder("Nox Hub/Library/");
		end;
		if not isfile(("Nox Hub/Library/" .. game.Players.LocalPlayer.Name .. ".json")) then
			writefile("Nox Hub/Library/" .. game.Players.LocalPlayer.Name .. ".json", (game:GetService("HttpService")):JSONEncode(SettingsLib));
		else
			local Decode = (game:GetService("HttpService")):JSONDecode(readfile("Nox Hub/Library/" .. game.Players.LocalPlayer.Name .. ".json"));
...
(getgenv()).SaveConfig = function()
	if readfile and writefile and isfile and isfolder then
		if not isfile(("Nox Hub/Library/" .. game.Players.LocalPlayer.Name .. ".json")) then
			...
			writefile("Nox Hub/Library/" .. game.Players.LocalPlayer.Name .. ".json", (game:GetService("HttpService")):JSONEncode(Array));
		end;
	else
		return warn("Status : Undetected Executor");
	end;
