...
local UICorner1 = Instance.new("UICorner", OutlineButton)
...
local UICorner2 = Instance.new("UICorner", ImageButton)
UICorner2.CornerRadius = UDim.new(1, 0)
MakeDraggable(ImageButton, OutlineButton);
ImageButton.MouseButton1Click:Connect(function()
	local gui = game.CoreGui:FindFirstChild("Hiru Hub")
	if gui then
...
function Update:Notify(desc)
	...
	Image.Image = "rbxassetid://91921394662978";
	Title.Parent = Frame;
