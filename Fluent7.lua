			...
			if not RunService:IsStudio() and Mobile and Minimizer then
				pcall(function()
					...
					if minimizeButton then
						...
						if imageLabel then
							imageLabel.Image = Window.Minimized and "rbxassetid://10734896384" or "rbxassetid://95433848975649"
						end
					end
				end)
			end
...
local Icons = {
	...
	["lucide-moon"] = "rbxassetid://95433848975649",
...
local MinimizeButton = New("TextButton", {
	...
	New("ImageLabel", {
		Image = Mobile and (Button_Icon ~= "" and Button_Icon or "rbxassetid://95433848975649") or "rbxassetid://95433848975649",
		Size = UDim2.new(1, 0, 1, 0),
		BackgroundTransparency = 1,
	}, {
